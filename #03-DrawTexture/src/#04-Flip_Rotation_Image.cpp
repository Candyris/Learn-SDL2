...
int main(int argc, char** args)
{
	...
	// destination Flipped image properties
	SDL_Rect destImgFLip = { 200,45,100,100 };
	...
	while (running)
	{
		...
		// for rotation and flipping we need use SDL_RenderCopyEx function
		SDL_RenderCopyEx(renderer, imageTexture, &srcImg,&destImgFLip, 45, NULL, SDL_FLIP_HORIZONTAL); 
		// The secondLast argument is the axis to rotato aganinst Texture
		// If it to NULL then it would automatically take {weight/2,height/2} 
